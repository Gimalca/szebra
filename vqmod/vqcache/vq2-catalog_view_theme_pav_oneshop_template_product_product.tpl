...
<div class="product-info">
    ...
    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 image-container">
        ...
        <?php } ?>
        <?php if ($images) { ?>
        <div class="image-additional slide carousel hidden-sm hidden-xs col-lg-3 col-md-3" id="image-additional"><div id="image-additional-carousel" class="carousel-inner">
        <?php 
...
<div id="content"><?php echo $content_top; ?>
  ...
  <ul id="tabs" class="nav nav-tabs clearfix">
    <li><?php if ($product_tabs_1) { ?>
					...
					<?php } ?>
				<?php } ?>
				<a href="#tab-description"><?php echo $tab_description; ?></a></li>
...
<?php if ($product_tabs_3) { ?>
  ...
  <div class="product-related box">
   <div class="box-heading"><span class="headding-title"><?php echo $tab_related; ?> (<?php echo count($products); ?>)</span></div>
  ...
  <div class="col-lg-<?php echo $span;?> col-md-3 col-sm-3 col-xs-12">
    <div class=" product-block">
        <div class="group-item">
          ...
          <?php } ?>
            ...
            <a href="<?php echo $zimage;?>" id="colorbox_<?php echo $product['product_id'];?>" class="info-view colorbox-related product-zoom" title="<?php echo $product['name']; ?>"><i class="fa fa-search-plus"></i></a>
            <?php } ?>
