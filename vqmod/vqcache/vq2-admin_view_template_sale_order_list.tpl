...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a onclick="if(!$('#form :checkbox:checked').length) return alert('Select at least one checkbox'); $('#form').attr('action', '<?php echo $this->url->link('sale/order/pdf_invoice', 'token=' . $this->session->data['token'], 'SSL'); ?>'); $('#form').attr('target', '_blank'); $('#form').submit();" class="button"><img src="../image/invoice/invoice-pdf1.png" style="vertical-align:top;padding-right:4px"/> <?php echo $this->language->get('button_pdf_invoice'); ?></a>
