...
if( !class_exists("ModuleSample") ) {
	class ModuleSample { 
		...
		public static function getStoreConfigs(){
			return array(
					'config_image_category_width' =>1170,
					'config_image_category_height' => 300,
					
					'config_image_thumb_width' =>550,
					'config_image_thumb_height' => 582,
					
					'config_image_popup_width' =>550,
					'config_image_popup_height' => 582,
					
					'config_image_product_width' =>550,
					'config_image_product_height' => 582,
					
					'config_image_additional_width' =>87,
					'config_image_additional_height' => 97,
					
					'config_image_related_width' =>550,
					'config_image_related_height' => 582,
