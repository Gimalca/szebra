<?php
/******************************************************
 * @package  : Pav Shop Location module for Opencart 1.5.x
 * @version  : 1.0
					...
					<div id="tab-module-<?php echo $module_row; ?>" class="vtabs-content">
							...
							<div id="tab-language-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>">
								<table class="form">
									<tr>
										...
										<td><input size="60" type="text" value="<?php echo isset($module['title'][$language['language_id']]) ? $module['title'][$language['language_id']] : ''; ?>" name="pavshoplocation_module[<?php echo $module_row; ?>][title][<?php echo $language['language_id']; ?>]"></td>
									</tr>
									<tr>
										<td><?php echo $this->language->get('entry_description'); ?></td>
										<td><textarea rows="2" cols="60" name="pavshoplocation_module[<?php echo $module_row; ?>][des][<?php echo $language['language_id']; ?>]" id="des-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>"><?php echo isset($module['des'][$language['language_id']]) ? $module['des'][$language['language_id']] : ''; ?></textarea></td>
									</tr>
								</table>
							</div>
							<?php } ?>
						<table class="form">
							<tr>
								...
								<td>
									<input name="pavshoplocation_module[<?php echo $module_row; ?>][prefix]" value="<?php echo (isset($module['prefix'])?$module['prefix']:'' ) ?>"/>
								</td>
							</tr>
							<tr>
								<td><?php echo $entry_layout; ?></td>
								<td><select name="pavshoplocation_module[<?php echo $module_row; ?>][layout_id]">
							...
							<tr>
								...
								<td><select name="pavshoplocation_module[<?php echo $module_row; ?>][position]">
							...
							<tr>
								...
								<td><select name="pavshoplocation_module[<?php echo $module_row; ?>][status]">
							...
							<tr>
								...
								<td><input type="text" name="pavshoplocation_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
							</tr>
							<tr>
								...
								<td>
									<div class="scrollbox">
										...
										<div class="<?php echo $class; ?>">
											<?php if (in_array($store['store_id'], $module['store_id'])) { ?>
											<input type="checkbox" name="pavshoplocation_module[<?php echo $module_row; ?>][store_id][]" value="<?php echo $store['store_id']; ?>" checked="checked" />
											<?php echo $store['name']; ?>
											<?php } else { ?>
											<input type="checkbox" name="pavshoplocation_module[<?php echo $module_row; ?>][store_id][]" value="<?php echo $store['store_id']; ?>" />
											<?php echo $store['name']; ?>
											<?php } ?>
										</div>
										<?php } ?>
							...
							<tr>
								...
								<td><input type="text" name="pavshoplocation_module[<?php echo $module_row; ?>][limit]" value="<?php echo isset($module['limit'])?$module['limit']:20; ?>" size="3" /></td>
							</tr>
							<tr>
								<td><?php echo $entry_height; ?></td>
								<td><input type="text" name="pavshoplocation_module[<?php echo $module_row; ?>][height]" value="<?php echo isset($module['height'])?$module['height']:400; ?>" size="3" /></td>
							</tr>
						</table>
					</div>
					<?php $module_row++; ?>
...
function addModule() {  
	...
	html += '				<td><input size="60" type="text" value="title" name="pavshoplocation_module[' + module_row + '][title][<?php echo $language['language_id']; ?>]"></td>';
	html += '			</tr>';
	html += '			<tr>';
	html += '				<td><?php echo $this->language->get("entry_description"); ?></td>';
	html += '				<td><textarea cols="60" rows="2" name="pavshoplocation_module[' + module_row + '][des][<?php echo $language['language_id']; ?>]" id="des-' + module_row + '-<?php echo $language['language_id']; ?>">Google Map</textarea></td>';
	html += '			</tr>';
	html += '		</table>';
	html += ' 	</div>';
	<?php } ?>
	...
	html += '		<td>';
	html += '			<input name="pavshoplocation_module['+module_row+'][prefix]" value="prefix_class'+module_row+'"/>';
	html += '		</td>';
	html += '	</tr>';
	html += '	<tr>';
	html += '		<td><?php echo $entry_layout; ?></td>';
	html += '		<td><select name="pavshoplocation_module[' + module_row + '][layout_id]">';
						<?php foreach ($layouts as $layout) { ?>
	...
	html += '		<td><select name="pavshoplocation_module[' + module_row + '][position]">';
						<?php foreach( $positions as $pos ) { ?>
	...
	html += '		<td><select name="pavshoplocation_module[' + module_row + '][status]">';
	...
	html += '		<td><input type="text" name="pavshoplocation_module[' + module_row + '][sort_order]" value="1" size="3" /></td>';
	html += '	</tr>';

	html += '	<tr>';
	html += '		<td><?php echo $entry_store; ?><span class="help"><?php echo $help_store; ?></span></td>';
	html += '		<td>';
	...
	html += '				<div class="<?php echo $class; ?>">';
								<?php $checked = ($store['store_id'] == 0)?'checked="checked"':''; ?>
	html += '					<input <?php echo $checked; ?> type="checkbox" name="pavshoplocation_module[<?php echo $module_row; ?>][store_id][]" value="<?php echo $store["store_id"]; ?>" />';
	html += '					<span><?php echo $store["name"]; ?></span>';
	html += '				</div>';
							<?php } ?>
	html += '				</div>';
	...
	html += '		<td><input type="text" name="pavshoplocation_module[' + module_row + '][limit]" value="200" size="3" /></td>';
	html += '	</tr>';
	html += '	<tr>';
	html += '		<td><?php echo $entry_height; ?><span class="help"></span></td>';
	html += '		<td><input type="text" name="pavshoplocation_module[' + module_row + '][height]" value="400" size="3" /></td>';
	html += '	</tr>';
	html += '</table>';
