...
class ControllerModulePavshoplocation extends Controller {
	protected function index($setting) {
		...
		if (file_exists('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/pavshoplocation.css')) {
			$this->document->addStyle('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/pavshoplocation.css');
		} else {
			$this->document->addStyle('catalog/view/theme/default/stylesheet/pavshoplocation.css');
		}
		...
		$locations = $this->model_pavshoplocation_location->getLocations($data);
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/pavshoplocation.tpl')){
			$this->template = $this->config->get('config_template') . '/template/module/pavshoplocation.tpl';
		} else {
			$this->template = 'default/template/module/pavshoplocation.tpl';
		}
