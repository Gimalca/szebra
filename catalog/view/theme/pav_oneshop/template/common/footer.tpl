...
<section id="footer">
	...
	?>
	<div class="footer-top footer-colums hidden-sm hidden-xs">
		<div class="container">
			<?php $j=1;foreach ($modules as $i =>  $module) {   ?>
				<?php if( $i++%$cols == 0 || count($modules)==1 ){  $j=1;?><div class="row"><?php } ?>	
	...
	<div class="footer-center footer-colums">
		...
		<?php $j=1;foreach ($modules as $i =>  $module) {  ?>
				<?php if( $i++%$cols == 0 || count($modules)==1 ){  $j=1;?><div class="row"><?php } ?>	
				<div class="<?php echo $class[$j];?>"><?php echo $module; ?></div>
                                <!--div style="border-left:none" class=" col-lg-3 col-md-3 "><img src="image/data/partners-first.jpg" class=""></div-->
				<?php if( $i%$cols == 0 || $i==count($modules) ){ ?></div><?php } ?>	
		<?php  $j++;  } ?>	
		</div>
	</div>
	...
	<div class="footer-bottom footer-colums">
		<div class="container">
			...
			<div class="row">
				...
				<?php if( isset($themeConfig['widget_aboutus_data'][$LANGUAGE_ID]) ) { ?>
					<div class="column col-xs-12 col-sm-6 col-md-3 col-lg-3">
						<div class="box aboutus-us">
							<div class="box-heading"><span>CONTÁCTANOS</span></div>
							<?php echo html_entity_decode( $themeConfig['widget_aboutus_data'][$LANGUAGE_ID], ENT_QUOTES, 'UTF-8' ); ?>
						</div>
					</div>
				<?php } ?>
			  	
			  	<?php if( isset($themeConfig['widget_stayconnect_data'][$LANGUAGE_ID]) ) { ?>
					<div class="column col-xs-12 col-sm-6 col-md-3 col-lg-3">
						<div class="box stayconnect-us">
							<div class="box-heading"><span><?php echo $this->language->get('text_stay_connect'); ?></span></div>
							<?php echo html_entity_decode( $themeConfig['widget_stayconnect_data'][$LANGUAGE_ID], ENT_QUOTES, 'UTF-8' ); ?>
						</div>
					</div>
				<?php } ?>
			...
			<div class="powered">
				<div class="copyright">
					...
					<?php } else { ?>
						<?php echo $powered; ?>. 
					<?php } ?>
					Desarrollado por: <a href="http://www.gimalca.com" title="Gimalca Soluciones C.A" target="_blank">Gimalca Soluciones</a>
				</div>
