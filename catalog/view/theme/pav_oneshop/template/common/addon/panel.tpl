...
$directories = glob( $this->_themeLessDir . 'opencart/skins/*', GLOB_ONLYDIR );
...
<div id="pav-paneltool" class="hidden-xs hidden-sm">
<div class="paneltool themetool">
	...
	<div class="panelcontent ">
		<div class="panelinner">
			<h4>Panel Tool</h4>
			<form action="<?php echo $_SERVER["REQUEST_URI"]; ?>" method="post" class="clearfix">
...
<div class="paneltool editortool hidden-sm hidden-md">
	<div class="panelbutton">
				...
				<div class="clearfix" id="customize-body">			
					...
					<div class="tab-content" > 
						...
						<div class="tab-pane" id="tab-<?php echo $for; ?>">
							<?php if( !empty( $output) ){?>
							<div class="accordion"  id="custom-<?php echo $for; ?>">
							<?php $i=0; foreach ( $output as $group ) { ?>
							   <div class="accordion-group clearfix">
									<div class="accordion-heading">
										<a class="accordion-toggle" data-toggle="collapse" data-parent="#custom-<?php echo $for; ?>" href="#collapse<?php echo $group['match'];?>">
