...
<div class="container">
	<?php if( $SPAN[0] ): ?>
		<aside class="col-lg-<?php echo $SPAN[0];?> col-md-<?php echo $SPAN[0];?> col-sm-<?php echo $SPAN[0];?> col-xs-12">
		...
		<div id="content">
			...
			<section class="pav-category wrapper blog-wrapper">
				...
				<div class="pav-children no-margin">
					<h3 class="blog-title"><?php echo $this->language->get('text_children');?></h3>
					<div class="children-wrap row">				
						<?php 
						$cols = (int)$config->get('children_columns');
						foreach( $children as $key => $sub )  { $key = $key + 1;?>
							<div class="col-lg-<?php echo floor(12/$cols);?> col-md-<?php echo floor(12/$cols);?> col-sm-<?php echo floor(12/$cols);?> col-xs-12">
