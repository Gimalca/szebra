...
<div class="row">
	...
	<section class="col-lg-<?php echo $SPAN[1];?> col-md-<?php echo $SPAN[1];?> col-sm-12 col-xs-12">  
		<div id="content">
            ...
            <p><img alt="" src="image/data/liea-directa.jpg" /></p>
								...
								<div class="content">		
									<div class="media">
										...
										<div class="media-body">
											<?php /*<strong><?php echo $text_address; ?></strong>*/ ?>
	            ...
	            <script type="text/javascript">
	                ...
	                var lat = <?php echo isset($themeConfig['location_latitude'])?$themeConfig['location_latitude']:'10.4210025'; ?>;
	                var lon = <?php echo isset($themeConfig['location_longitude'])?$themeConfig['location_longitude']:'-66.8023618'; ?>;
	                jQuery(document).ready(function($) {
	                    ...
	                    mapDiv.height(400).gmap3({
	                        ...
	                        marker:{
	                            values:[
	                                {latLng:[lat, lon], data:"<?php echo isset($themeConfig['location_address'])?$themeConfig['location_address']:'Centro Comercial Terraza, Avenida Las Lomas,Caracas,Venezuela'; ?>"},
	                            ],
	                            options:{
	                                draggable: false
	                            },
