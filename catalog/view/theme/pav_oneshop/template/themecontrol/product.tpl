...
<div class="product-info">
    ...
    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 image-container">
        <?php if ($thumb) { ?>
        <div class="image col-lg-9 col-md-12">
        <?php if( $special )  { ?>
          <div class="product-label-special label"><?php echo $this->language->get( 'text_sale' ); ?></div>
        <?php } ?>
          <img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image"  data-zoom-image="<?php echo $popup; ?>" class="product-image-zoom"/></div>
        <?php } ?>
        <?php if ($images) { ?>
        <div class="image-additional slide carousel hidden-sm hidden-xs col-lg-3 col-md-12" id="image-additional"><div id="image-additional-carousel" class="carousel-inner">
        <?php 
      ...
      <div class="description">
        ...
        <div class="product-extra">
          ...
          <div class="action pull-left">
            <span class="wishlist">
              <a onclick="addToWishList('<?php echo $product_id; ?>');" data-placement="top" data-original-title="<?php echo $button_wishlist; ?>"><?php echo $button_wishlist; ?></a>
            </span>
            <span class="compare">
              <a onclick="addToCompare('<?php echo $product_id; ?>');" data-placement="top" data-original-title="<?php echo $button_compare; ?>"><span><?php echo $button_compare; ?></span></a>
            </span>
          </div>
        </div>
        <?php if ($minimum > 1) { ?>
